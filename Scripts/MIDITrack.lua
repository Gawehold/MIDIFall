class "MIDITrack" {
	...
	getCustomColorHSV = function (self)
		return self.customColorHSV
	end,
	
	setCustomColorHSV = function (self, h,s,v)
		self.customColorHSV[1] = h
		self.customColorHSV[2] = s
		self.customColorHSV[3] = v
	end,
